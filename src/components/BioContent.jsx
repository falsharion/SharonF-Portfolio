    ...
    <div className="px-6 z-50 flex flex-col h-[calc(100%-120px)]">
      ...
      <div className="mt-auto mb-4">
        <Modal>
          ...
          <ModalBody>
            <ModalContent>
              <div className="sticky top-0 z-50 bg-zinc-700/50 pt-4 ">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.3 }}
                >
                  <h4 className="text-lg md:text-2xl text-violet-200 dark:text-neutral-100 font-bold text-center flex justify-center items-center">
                    About Me{" "}
                    <motion.span
                      initial={{ scale: 0.95 }}
